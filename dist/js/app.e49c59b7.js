(function(e) {
    ...
    function c(e) {
        return s.p + "js/" + ({} [e] || e) + "." + {
            "chunk-2a286362": "28e897ea",
            "chunk-2d0aed92": "ee92bfe8",
            "chunk-2d0af48a": "2a7f864b",
            "chunk-0547c3c8": "6e046de5",
            "chunk-2d0c4c28": "37bed2e6",
            "chunk-50779d2e": "f2a32ba4",
            "chunk-2d0b2ee4": "5e57f531",
            "chunk-48822c69": "84781d86",
            "chunk-498d4d6d": "b50c8ae9",
            "chunk-91c3565e": "89cfe713",
            "chunk-d364e3a0": "7582266a"
        } [e] + ".js"
    }
    function s(t) {
    ...
    s.p = "https://cdn.jsdelivr.net/gh/Aicirou/goindex-theme-acrou@v2.0.5/dist/",
    s.oe = function(e) {
    ...
    "45d8": function(e, t, a) {
        ...
        l = function(e) {
            ...
            n = p(e);
            return - 1 != o.indexOf("".concat(a)) && (e = e.replace(/\/(\d+:)\/.*/, (function(e, t) {
                return "/".concat(t, "text/").concat(n)
            }))),
            -1 != s.indexOf("".concat(a)) && (e = e.replace(/\/(\d+:)\/.*/, (function(e, t) {
                return "/".concat(t, "pdf/").concat(n)
            }))),
            -1 != i.indexOf("".concat(a)) && (e = e.replace(/\/(\d+:)\/.*/, (function(e, t) {
                return "/".concat(t, "video/").concat(n)
            }))),
            -1 != c.indexOf("".concat(a)) && (e = e.replace(/\/(\d+:)\/.*/, (function(e, t) {
        ...
        f = function(e) {
            var t = e.split("/").pop(),
            a = t.split(".").pop().toLowerCase(),
            n = o.concat.apply(o, i.concat(c, s));
        ...
        function g(e, t) {
            ...
            for (var r in /(Y+)/.test(t) && (t = t.replace(RegExp.$1, (e.getFullYear() + "").substr(4 - RegExp.$1.length))), /(E+)/.test(t) && (t = t.replace(RegExp.$1, (RegExp.$1.length > 1 ? RegExp.$1.length > 2 ? "星期": "周": "") + n[e.getDay() + ""])), a) new RegExp("(" + r + ")").test(t) && (t = t.replace(RegExp.$1, 1 === RegExp.$1.length ? a[r] : ("00" + a[r]).substr(("" + a[r]).length)));
            return t
        }
    },
    "49f8": function(e, t, a) {
    ...
    "56d7": function(e, t, a) {
        ...
        d = u,
        l = a("2877"),
        f = Object(l["a"])(d, o, i, !1, null, null, null),
        p = f.exports,
        h = a("5f72"),
        v = a.n(h),
        m = (a("aaa5"), a("46a1"), a("be4f"), a("9bd2")),
        g = a("a7fe"),
        b = a.n(g),
        w = a("a18c"),
        k = (a("4160"), a("d81d"), a("b64b"), a("d3b7"), a("466d"), a("159b"), a("ddb0"), a("85b3")),
        y = a.n(k);
        function O() {
            var e = a("49f8"),
            t = {};
        ...
        r.a.use(y.a);
        var x = O();
        r.a.prototype.$languages = Object.keys(x).map((function(e) {
            return {
                label: x[e]._name,
                value: e
            }
        ...
        L = a.n(_),
        N = a("cbd9");
        r.a.component("markdown", (function() {
            return Promise.all([a.e("chunk-2d0af48a"), a.e("chunk-0547c3c8")]).then(a.bind(null, "b6ba"))
        }));
        a("0808"),
        a("e558");
        ...
        r.a.prototype.$cdnpath = N["a"],
        r.a.use(v.a),
        r.a.use(b.a, m["a"]),
        r.a.use(C.a),
        r.a.use(P["a"], {
            loading: Object(N["a"])("images/airplane.gif")
        }),
        r.a.use(L.a),
        new r.a({
            router: w["a"],
    ...
    "6c69": function(e, t, a) {
        ...
        var n = function() {
            ...
            })])])])]), a("header-locales"), e._m(0), a("header-setting"), a("a", {
        ...
        h = (a("4160"), a("c975"), a("b64b"), a("d3b7"), a("159b"), {
            data: function() {
                return {}
            },
            methods: {
        ...
        k = w,
        y = Object(u["a"])(k, n, r, !1, null, null, null);
        t["default"] = y.exports
    },
    "85b3": function(e, t) {
        e.exports = VueI18n
    ...
    "88e9": function(e, t, a) {
        ...
        var n = function() {
            ...
            [a("feb-alive", [a("router-view")], 1), a("Footer")], 1)])], 1)
        },
        r = [],
        o = a("e0a1"),
        i = a("a1c2"),
    ...
    9320 : function(e, t, a) {
        ...
        t["default"] = {
            ...
            actions: {
                ...
                conver: function(e, t) {
                    var a = e.dispatch,
                    n = o["a"].app.$route.path;
                    return t ? t.map((function(e) {
                        var t = n + Object(i["c"])(e.name, e),
                        o = "application/vnd.google-apps.folder" === e.mimeType,
                        c = o ? "-": Object(i["f"])(e.size),
                        s = Object(r["a"])({
                            path: t
                        },
                        e, {
                            modifiedTime: Object(i["e"])(e.modifiedTime),
                            size: c,
                            isFolder: o
                        });
                        return a("renderMd", s),
                        ...
                        return e.isFolder && t.isFolder ? 0 : e.isFolder ? -1 : 1
                    })) : []
                },
                renderMd: function(e) {
                    var t = this;
                    return new Promise((function(a) {
                        var n = o["a"].app.$route.params.cmd;
                        n || ("HEAD.md" === e.name && (t.headmd = {
                            display: !0,
                            file: e,
                            path: e.path
                        }), "README.md" === e.name && (t.readmemd = {
                            display: !0,
                            file: e,
                            path: e.path
                        })),
            ...
            mutations: {
                ...
                push: function(e, t) {
                    var a; (a = e.files).push.apply(a, Object(n["a"])(t))
                },
                setHeadmd: function(e, t) {
                    e.headmd = t
                },
                setReadmemd: function(e, t) {
                    e.readmemd = t
                }
            }
        }
    ...
    "95a2": function(e, t, a) {
        ...
        c = a("c276"),
        s = a("60bb"),
        u = new i.a("go2index-".concat("2.0.5")),
        d = r()(u);
        function l(e) {
            var t = e.dbName,
    ...
    "9bd2": function(e, t, a) {
        ...
        c = r.a.create({
            baseURL: Object({
                ...
                VUE_APP_CDN_PATH: "https://cdn.jsdelivr.net/gh/Aicirou/goindex-theme-acrou@v2.0.5/dist/",
                VUE_APP_VERSION: "2.0.5",
                VUE_APP_G2INDEX_VERSION: "1.1.1",
                BASE_URL: "https://cdn.jsdelivr.net/gh/Aicirou/goindex-theme-acrou@v2.0.5/dist/"
            }).VUE_APP_API ? Object({
                NODE_ENV: "production",
                VUE_APP_I18N_LOCALE: "zh-chs",
                VUE_APP_I18N_FALLBACK_LOCALE: "en",
    ...
    "9dac": function(e, t, a) {
        var n = {
            "./Layout": ["88e9"],
            "./Layout.vue": ["88e9"],
            "./common/BreadCrumb": ["2db9", "chunk-2a286362"],
            "./common/BreadCrumb.vue": ["2db9", "chunk-2a286362"],
            "./common/Footer": ["a1c2"],
            "./common/Footer.vue": ["a1c2"],
            "./common/Head": ["e0a1"],
            "./common/Head.vue": ["e0a1"],
            "./common/Markdown": ["3bcf", "chunk-2d0af48a", "chunk-2d0c4c28"],
            "./common/Markdown.vue": ["3bcf", "chunk-2d0af48a", "chunk-2d0c4c28"],
            "./common/Navbar": ["6c69"],
            "./common/Navbar.vue": ["6c69"],
            "./page/GoImg": ["0c8a", "chunk-2d0aed92"],
            "./page/GoImg.vue": ["0c8a", "chunk-2d0aed92"],
            "./page/GoList": ["e65d", "chunk-2d0af48a", "chunk-50779d2e"],
            "./page/GoList.vue": ["e65d", "chunk-2d0af48a", "chunk-50779d2e"],
            ...
            "./page/components/grid": ["2a7a", "chunk-91c3565e"],
            "./page/components/grid/": ["2a7a", "chunk-91c3565e"],
            "./page/components/grid/index": ["2a7a", "chunk-91c3565e"],
            "./page/components/grid/index.vue": ["2a7a", "chunk-91c3565e"],
        ...
        g.beforeEach(function() {
            var e = Object(n["a"])(regeneratorRuntime.mark((function e(t, a, n) {
                return regeneratorRuntime.wrap((function(e) {
                    ...
                    case 0:
                        0,
                        h["a"].dispatch("acrou/cancelToken/cancel"),
                        n();
                    case 3:
                    case "end":
                        return e.stop()
    ...
    c276: function(e, t, a) {
        ...
        o = {
            set: function() {
                ...
                Object.assign(n, a),
                r.a.set("go2index-".concat("2.0.5", "-").concat(e), t, n)
            },
            get: function() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "default";
                return r.a.get("go2index-".concat("2.0.5", "-").concat(e))
            },
            getAll: function() {
                return r.a.get()
            },
            remove: function() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "default";
                return r.a.remove("go2index-".concat("2.0.5", "-").concat(e))
            }
        },
        i = o,
        c = a("95a2"),
    ...
    cbd9: function(e, t, a) {
        "use strict";
        function n(e) {
            var t = "https://cdn.jsdelivr.net/gh/Aicirou/goindex-theme-acrou@v2.0.5/dist/";
            return t + e
        }
        a.d(t, "a", (function() {
            return n
    ...
    edd4: function(e) {
        e.exports = JSON.parse('{"_name":"English","languages":"Languages","index":"Home","folder":"Folder","notify":{"title":"Notify"},"copy":{"success":"Copy successful","error":"Copy failed"},"list":{"view":{"gridMode":"Grid view","listMode":"List view"},"auth":"Directory encryption, please enter password","title":{"file":"File","moditime":"Modified Time","size":"Size","operation":"Actions"},"loading":"Loading...","opt":{"copy":"Copy link","newTab":"Open a new tab","download":"Download"},"total":"Total","item":"item"},"search":{"placeholder":"Search resources..."},"page":{"video":{"play":"Play","download":"Download","link":"Download link"},"text":{"loading":"Loading..."}},"setting":{"clear":{"text":"Clean cache","success":"Cache cleanup successful"}},"checkVersion":{"tips":"New version detected, <a href=\'${url}\'>Go to GitHub</a>"}}')
    },
    f3f7: function(e, t, a) {
        "use strict";
        var n = function() {
